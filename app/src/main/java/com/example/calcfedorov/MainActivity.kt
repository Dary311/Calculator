package com.example.calcfedorov

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.view.ViewTreeObserver
import android.widget.Toast
import com.example.calcfedorov.databinding.ActivityMainBinding
...
// Вызов методов  для настройки обработчиков событий для кнопок.
    ...
    //Метод Проверяет, можно ли добавить оператор к текущему выражению.
    ...
    //Настройка обработчиков событий для кнопок с операторами и других функциональных кнопок (AC, Delete, Equals).
    ...
    //Метод Добавляет текст к выражению, выполняя ряд проверок и настроек прокрутки горизонтального скроллинга.
    ...
    //Добавляет скобки к выражению в зависимости от текущего состояния.
    ...
    //Метод Подсчитывает количество открытых и закрытых скобок в выражении.
    ...
    //Метод Проверяет, допустима ли операция, добавляемая к текущему выражению.
